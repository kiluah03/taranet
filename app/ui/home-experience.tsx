...
export function HomeExperience() {
  ...
  return <main className="landing">
    ...
    <section className="landing-section cultural" id="why">
      <motion.div className="landing-heading" {...reveal}><p className="landing-kicker">Two homes, one strong connection</p><h2>Competetive price, Business opportunity-referral fee, Community technical support</h2><p>Technology with warmth, service with malasakit, and a network made for the life your family is building.</p></motion.div>
